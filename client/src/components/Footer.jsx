...
const Footer = () => {
  return (
    <div>
      <footer className="bg-white lg:grid lg:grid-cols-5 dark:bg-dark w-[98.9vw] relative bottom-0 z-10">
        <div className="relative block h-32 lg:col-span-2 lg:h-full">
          <img
            src={sign}
            alt=""
            className="absolute inset-0 h-full w-full object-cover w-[39vw]"
          />
        </div>
        <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              <img src={logo} alt="" className="w-[20vw] pb-5 p-0" />
              <p>
