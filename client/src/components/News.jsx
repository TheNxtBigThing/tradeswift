...
export default function News() {
  ...
  return (
    <div id="news-container" className="w-full text-center">
      <center>
        <h1 className="text-base font-semibold rounded-3xl bg-sky-400 text-white p-1 text-nowrap w-min mb-[10px]">today's tradenews</h1>
        {articles.map((article, index) => {
          ...
          return (
            <div>
              <div
                key={index}
                className="card mb-[20px] bg-sky-200 dark:bg-sky-600 w-[12rem] rounded-lg mt-[0px]"
                data-aos="fade-down"
              >
                <header>
                  <h3>
